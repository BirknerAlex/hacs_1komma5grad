...
class HeartbeatConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        ...
        _LOGGER.debug("ConfigFlow.async_get_options_flow called for %s", getattr(config_entry, "entry_id", config_entry))
...
def async_get_options_flow(config_entry):
    ...
    _LOGGER.debug("module-level async_get_options_flow called for %s", getattr(config_entry, "entry_id", config_entry))
    return OptionsFlowHandler(config_entry)
...
class OptionsFlowHandler(config_entries.OptionsFlow):
    ...
    def __init__(self, config_entry):
        _LOGGER.debug("OptionsFlowHandler init for config_entry %s", getattr(config_entry, "entry_id", config_entry))
